...
// NoorReader
//
// Enhanced text selection actions popover with full color palette, note support, and AI actions
...
struct SelectionPopover: View {
    ...
    private var hasAIActions: Bool {
        onSummarize != nil || onExplain != nil || onCreateFlashcard != nil
    }
    ...
    var body: some View {
        ...
        .frame(width: hasAIActions ? 300 : 260)
